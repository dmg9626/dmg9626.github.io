...
<img src="/blog/proc-gen/images/diamond_square.png" class="blog text-center" width="100%" height="auto">
...
<img src="/blog/proc-gen/images/water-level/fixed/15-percent-1.png" class="blog text-center" width="400px" height="auto">

Hmm, that's much more water than I expected, but maybe that was an unlucky seed. Let's try a few more maps.

<div class="row">
    <img src="/blog/proc-gen/images/water-level/fixed/15-percent-2.png" class="blog text-center" width="400px" height="auto">
    <img src="/blog/proc-gen/images/water-level/fixed/15-percent-3.png" class="blog text-center" width="400px" height="auto">
</div>

Maybe I should try a lower water level? I'll plug in .05 and see what we get:

<div class="row">
    <img src="/blog/proc-gen/images/water-level/fixed/5-percent-1.png" class="blog text-center" width="400px" height="auto">
    <img src="/blog/proc-gen/images/water-level/fixed/5-percent-2.png" class="blog text-center" width="400px" height="auto">
</div>
...
<div class="row">
    <img src="/blog/proc-gen/images/water-level/calculated/calculated-1.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/water-level/calculated/calculated-2.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/water-level/calculated/calculated-3.png" class="blog text-center" width="350px" height="auto">
</div>
...
<div class="row">
    <img src="/blog/proc-gen/images/cleanup-patches/v1/before-cleanup.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/cleanup-patches/v1/cleanup-land-patches.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/cleanup-patches/v1/cleanup-water-patches.png" class="blog text-center" width="350px" height="auto">
</div>
...
<div class="row">
    <img src="/blog/proc-gen/images/cleanup-patches/v2/before-cleanup.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/cleanup-patches/v2/cleanup-land-patches.png" class="blog text-center" width="350px" height="auto">
    <img src="/blog/proc-gen/images/cleanup-patches/v2/cleanup-water-patches.png" class="blog text-center" width="350px" height="auto">
</div>
...
<img src="/blog/proc-gen/images/decoration-pass/sand-pass.png" class="blog text-center" width="400px" height="auto">
...
<img src="/blog/proc-gen/images/decoration-pass/tree-pass-1.png" class="blog text-center" width="400px" height="auto">
...
<img src="/blog/proc-gen/images/decoration-pass/tree-pass-2.png" class="blog text-center" width="400px" height="auto">
